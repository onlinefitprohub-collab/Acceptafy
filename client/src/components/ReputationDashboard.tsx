...
export const ReputationDashboard: React.FC<ReputationDashboardProps> = ({ history }) => {
    ...
    return (
        <div className="mt-8 bg-muted/50 backdrop-blur-lg border border-border rounded-2xl shadow-lg" data-testid="reputation-dashboard">
            <button
                type="button"
            ...
            >
                <div className="flex items-center gap-3">
                    <span className="text-purple-600 dark:text-purple-400"><PreFlightIcon /></span>
                    <h3 className="text-lg sm:text-xl font-semibold text-foreground">Reputation Dashboard</h3>
                </div>
                            ...
                            <div className="space-y-8">
                               <div>
                                    <div className="flex items-center gap-3 mb-4">
                                        <span className="text-purple-600 dark:text-purple-400"><AnalyticsIcon /></span>
                                        <h3 className="text-xl font-bold text-foreground">Score History</h3>
                                    </div>
