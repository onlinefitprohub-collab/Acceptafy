    ...
    <InfoCard title="Email Sending Recommendations" icon={Clock} variant="info">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm border-collapse rounded-lg overflow-hidden">
          <thead>
            <tr className="bg-gradient-to-r from-purple-600/20 to-green-600/20">
              <th className="text-left py-3 px-3 font-bold text-foreground border-r border-border/30">Stage</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20 bg-purple-500/10">1</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20">2</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20 bg-purple-500/10">3</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20">4</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20 bg-purple-500/10">5</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20">6</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20 bg-purple-500/10">7</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20">8</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20 bg-purple-500/10">9</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20">10</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20 bg-green-500/10">11</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20">12</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20 bg-green-500/10">13</th>
              <th className="text-center py-3 px-2 font-bold border-r border-border/20">14</th>
              <th className="text-center py-3 px-2 font-bold bg-green-500/10">15</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-t border-border/30">
              <td className="py-3 px-3 font-bold text-amber-400 border-r border-border/30 bg-amber-500/5">Hourly</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-purple-500/5">100</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20">300</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-purple-500/5">600</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20">800</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-purple-500/5">1K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20">1.5K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-purple-500/5">2K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20">3K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-purple-500/5">3.5K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20">4.5K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-green-500/5">6.5K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20">10K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-green-500/5">16K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20">25K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold bg-green-500/5">50K</td>
            </tr>
            <tr className="border-t border-border/30 bg-muted/30">
              <td className="py-3 px-3 font-bold text-purple-400 border-r border-border/30 bg-purple-500/10">Daily</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-purple-500/10">1K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-muted/20">2.5K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-purple-500/10">5K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-muted/20">6.5K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-purple-500/10">8K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-muted/20">10K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-purple-500/10">14K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-muted/20">20K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-purple-500/10">25K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-muted/20">35K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-green-500/10">50K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-muted/20">80K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-green-500/10">125K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold border-r border-border/20 bg-muted/20">175K</td>
              <td className="text-center py-3 px-2 font-mono font-semibold bg-green-500/10">250K</td>
            </tr>
          </tbody>
        </table>
      </div>
