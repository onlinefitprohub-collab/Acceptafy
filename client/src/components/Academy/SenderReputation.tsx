    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            >
                ...
                <p><strong className="text-foreground">There are two main types of reputation:</strong></p>
                <ul className="list-disc list-inside space-y-1 mt-2">
                    <li><strong className="text-foreground">IP Reputation:</strong> Tied to the specific mail server (IP address) sending the email. This is mostly managed by your Email Service Provider (ESP).</li>
                    <li><strong className="text-foreground">Domain Reputation:</strong> Tied to your sending domain (e.g., yourcompany.com). This is YOUR reputation, and it follows you even if you switch ESPs. It is the more important factor for long-term success.</li>
                </ul>
            </SectionWrapper>
                ...
                <p>ISPs are constantly watching how recipients interact with your emails. They use these interactions as signals to adjust your reputation score up or down.</p>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-2">
                    <div className="bg-green-500/10 p-4 rounded-lg border border-green-500/20">
                        <h4 className="font-bold text-green-600 dark:text-green-300">Positive Signals (Increase Your Score)</h4>
                     ...
                     <div className="bg-red-500/10 p-4 rounded-lg border border-red-500/20">
                        <h4 className="font-bold text-red-600 dark:text-red-300">Negative Signals (Decrease Your Score)</h4>
                        <ul className="list-disc list-inside space-y-1 mt-2 text-sm text-muted-foreground">
            ...
            <InfoBox icon={<MonitorIcon />}>
                <div>
                    <h4 className="font-bold text-foreground">How to Monitor Your Reputation</h4>
                    <p className="text-purple-600 dark:text-purple-200 text-sm">A great free tool for this is <strong className="font-semibold">Google Postmaster Tools</strong>. Setting it up gives you direct insight into how Gmail views your domain's reputation, including data on spam complaint rates, IP reputation, and more.</p>
                </div>
            </InfoBox>
