    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            >
                ...
                <p><strong className="text-foreground">A re-engagement campaign has two primary goals:</strong></p>
            ...
            >
                ...
                <ol className="list-decimal list-inside space-y-3 mt-2">
                    <li>
                        <strong className="text-foreground">Email 1: The Gentle Nudge (Day 1)</strong>
                    ...
                    <li>
                        <strong className="text-foreground">Email 2: The Compelling Offer (Day 5)</strong>
                    ...
                    <li>
                        <strong className="text-foreground">Email 3: The "Break-Up" Email (Day 14)</strong>
            ...
            <InfoBox icon={<BlueprintIcon />}>
                <div>
                    <h4 className="font-bold text-foreground">The Golden Rule</h4>
                    <p className="text-purple-600 dark:text-purple-200 text-sm">You MUST be willing to remove subscribers who do not respond to this campaign. A smaller, more engaged list will always outperform a larger, inactive one in the long run. List hygiene is the secret of top-tier email marketers.</p>
                </div>
            </InfoBox>
