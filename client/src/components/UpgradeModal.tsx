    ...
    >
      ...
      >
        ...
        <main className="p-6 space-y-6">
            <p className="text-center text-gray-300">Unlock our most powerful features to maximize your deliverability and supercharge your email campaigns.</p>
            
            <div className="space-y-5">
                <ProFeature 
                    icon={<FollowUpIcon />} 
                    title="10-Email Sequence Generator"
                    description="Automatically create entire value-driven follow-up campaigns for any scenario."
                />
                 <ProFeature 
                    icon={<PreFlightIcon />} 
                ...
                />
                 <ProFeature 
                    ...
                    description="Unlock all advanced modules, blueprints, and the interactive scenario simulator."
                />
            </div>
        </main>
        ...
        <footer className="p-5 bg-black/20 border-t border-white/10">
             <button 
                onClick={onClose} 
                className="w-full px-8 py-3 bg-purple-600 text-white font-bold rounded-lg hover:bg-purple-700 transition-all duration-300 shadow-[0_0_15px_rgba(168,85,247,0.5)] shimmer-effect"
                data-testid="button-upgrade-now"
             >
                Upgrade Now & Go Pro
            </button>
            <p className="text-center text-xs text-gray-500 mt-3">This is a demo. Clicking this button will close the modal.</p>
        </footer>
