...
type ActiveTab = 'core' | 'risks' | 'technical';
...
const TabButton: React.FC<{
    ...
    <button
        onClick={onClick}
        className={`w-full sm:w-auto flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold rounded-md transition-all duration-300 ${isActive ? 'bg-purple-600 text-white shadow-md' : 'text-gray-300 hover:bg-white/10'}`}
