...
export const ErrorMessage: React.FC<ErrorMessageProps> = ({ message, onDismiss }) => {
  ...
  return (
    <div className="mb-6 p-4 bg-red-900/50 border border-red-500 text-red-200 rounded-lg flex flex-col sm:flex-row items-start justify-between gap-4 animate-fade-in" role="alert">
      ...
      <button
        onClick={onDismiss}
        className="p-1.5 text-red-300 rounded-full hover:bg-red-500/30 transition-colors self-start sm:self-center flex-shrink-0"
