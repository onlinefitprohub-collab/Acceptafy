...
export const SUBSCRIPTION_LIMITS = {
  starter: {
    ...
    deliverabilityChecksPerMonth: 25,
    gradesPerDay: 5,
    rewritesPerDay: 5,
    followupsPerDay: 15,
  ...
  pro: {
    gradesPerMonth: 1000,
    rewritesPerMonth: 500,
    followupsPerMonth: 250,
    deliverabilityChecksPerMonth: 200,
    gradesPerDay: 75,
    rewritesPerDay: 40,
    followupsPerDay: 25,
    deliverabilityChecksPerDay: 20,
    historyLimit: 10000,
  ...
  scale: {
    gradesPerMonth: 5000,
    rewritesPerMonth: 2500,
    followupsPerMonth: 1000,
    deliverabilityChecksPerMonth: 750,
    gradesPerDay: 250,
    rewritesPerDay: 125,
    followupsPerDay: 75,
    deliverabilityChecksPerDay: 50,
    historyLimit: 100000,
    advancedSpamAnalysis: true,
